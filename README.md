# chaozzDB - An easy-to-use flatfile nomysql database system for PHP
...
## Functions
- **chaozzdb_password(); ** You can use this to salt passwords before storing them into chaozzdb. > $password = chaozzdb_password('ThisIsMyPassword123');
